...
// MARK: - N2K low-level helpers (shared by snapshot + parser)

enum N2KParseError: Error {
    case invalidLine
    case invalidCANID
    case notEnoughBytes
}
...
func parseRawN2KLine(_ line: String) throws -> N2KFrame {
    ...
    // Decode PGN from CAN ID (per NMEA 2000 / J1939 header layout)
...
func s32(_ data: [UInt8], _ idx: Int) -> Int32? {
    guard let v = u32(data, idx) else { return nil }
    return Int32(bitPattern: v)
}

/// NMEA "not available" helpers
func isU16NA(_ v: UInt16, allBits: UInt16 = 0xFFFF) -> Bool {
    return v == allBits
}

func isS32NA(_ v: Int32) -> Bool {
